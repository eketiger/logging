...
DEPTH = [1100.5,1101,1101.5,1102,1102.5,1103,1103.5,1104,1104.5,1105,1105.5,1106,1106.5,1107,1107.5,1108,1108.5,1109] # se sefine la lista DEPTH
...
df = pd.DataFrame({'depth' : DEPTH, 'paso' : PASO, 'cbl' : CBL}) # lleva las listas a un dataframe
...
toc = DEPTH[z] # toc es el tope de cemento definido.

df_new = df[DEPTH.index(toc):] # genero un dataframe en el que se eliminan los valores superiores al tope de cemento.
